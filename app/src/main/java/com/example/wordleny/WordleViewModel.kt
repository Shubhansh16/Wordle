...
import com.example.wordleny.data.WORD_LENGTH
import com.example.wordleny.data.wordList
import com.example.wordleny.data.wordListSize
import com.example.wordleny.util.listToWord
import com.example.wordleny.util.wordlistBinarySearch
...
class WordleViewModel() : ViewModel() {
    ...
    private fun getNewWordle() {
        r = java.util.Random(System.nanoTime()).nextInt(wordListSize)
    }
}
